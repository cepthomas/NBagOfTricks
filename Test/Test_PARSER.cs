...
{
    public class UTILS_PARSER : TestSuite
    {
        public override void RunSuite()
        {
            UT_INFO("Tests parser.");

            StringReader srdr = new StringReader(File.ReadAllText(@".\files\test.json"));
            var jp = new JsonParser(srdr);
            ...
            {
                //File.WriteAllText(fname + ".out", string.Join(Environment.NewLine, jp.Errors));
            }
